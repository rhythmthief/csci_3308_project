...
QUERIES[5]="CREATE TABLE IF NOT EXISTS students(id serial primary key, student_name VARCHAR(50) NOT NULL,skills varchar(250),about_me varchar(500),school varchar(50),student_email varchar(50), accepted_jobs smallint[]);"
